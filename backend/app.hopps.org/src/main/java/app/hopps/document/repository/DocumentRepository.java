...
public class DocumentRepository implements PanacheRepository<Document> {
    ...
    /**
     * Finds all unassigned documents (no bommel) within the current organization.
     *
    ...
    /**
     * Finds a document by ID, scoped to the current organization. This prevents cross-organization access.
     *
     * @param id
     *            The document ID
     *
