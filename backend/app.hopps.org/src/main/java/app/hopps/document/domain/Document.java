...
public class Document extends PanacheEntity {
    ...
    /**
     * Adds a tag with the specified source. If the tag already exists on this document, it will not be added again.
     */
    ...
    /**
     * Returns true if the document is ready for review (analysis complete, awaiting user confirmation).
     */
