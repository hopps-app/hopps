...
public class TradePartyRepository implements PanacheRepository<TradeParty> {
    ...
    /**
     * Finds a trade party by ID, scoped to the current organization. This prevents cross-organization access.
     *
     * @param id
     *            The trade party ID
     *
     * @return The trade party, or null if not found or not in current organization
     */
