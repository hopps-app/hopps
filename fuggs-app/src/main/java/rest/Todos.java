...
/**
 * This defines a REST controller, each method will be available under the
 * "Classname/method" URI by convention
 */
public class Todos extends Controller
{
	...
	{
		/**
		 * This specifies that the Todos/index.html template does not take any
		 * parameter
		 */
		public static native TemplateInstance index();

		/**
		 * This specifies that the Todos/todos.html template takes a todos
		 * parameter of type List&lt;Todo&gt;
		 */
	...
	{
		// If validation fails, redirect to the todos page (with errors
		// propagated)
		if (validationFailed())
		{
			// redirect to the todos page by just calling the method: it does
			// not return!
			todos();
		}
		// save the new Todo
