 ...
 * in the Keycloak realm. When an alias is not listed here we fall back to the
            ...
            socialProvidersNode={
                <>
                    {realm.password && social?.providers !== undefined && social.providers.length !== 0 && (
                        <div id="kc-social-providers" className={clsx(kcClsx("kcFormSocialAccountSectionClass"), "custom-social-providers")}>
                            <div className="custom-social-divider">
                                <span>{msg("identity-provider-login-label")}</span>
                            </div>
                            <ul className={kcClsx("kcFormSocialAccountListClass", social.providers.length > 3 && "kcFormSocialAccountListGridClass")}>
                                {social.providers.map((...[p, , providers]) => {
                                    const brandLogo = providerLogos[p.alias];
