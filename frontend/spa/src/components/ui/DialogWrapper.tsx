...
export default function DialogWrapper({ trigger, title, description, children, onSuccess, formId, primaryLabel, secondaryLabel, primaryDisabled }: DialogWrapperProps) {
        ...
        <Dialog open={open} onOpenChange={handleOpenChange}>
            ...
            <Portal>
                ...
                <Content className="fixed left-1/2 top-1/2 w-[90vw] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-xl bg-white p-6 shadow-xl">
                    ...
                    <div className="mt-4">{typeof children === 'function' ? children({ onSuccess: handleSuccess, setOpen, setSubmitting: handleSetSubmitting }) : children}</div>
