    ...
    return (
        <div className="flex flex-col items-center justify-center py-16 px-4">
            <div className="bg-white rounded-[30px] p-8 max-w-2xl w-full flex flex-col items-center">
                ...
                <h3 className="text-lg font-semibold text-black mb-2">{t('receipts.emptyState.title')}</h3>
                <p className="text-sm text-black text-center mb-6">{t('receipts.emptyState.description')}</p>
