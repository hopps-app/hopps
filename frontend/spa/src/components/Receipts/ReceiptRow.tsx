            ...
            <div ref={expandRef} className="overflow-hidden transition-[max-height] duration-200 ease-in-out" style={{ maxHeight: 0 }}>
                ...
                <div className="px-5 pb-4 pt-3">
                    {(receipt.dueDate || receipt.area || receipt.tags.length > 0) && (
                        <div className="rounded-[10px] bg-white dark:bg-[var(--purple-100)] p-2">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                                ...
                                {receipt.area && (
                                    <div className="px-1 py-1">
                                        ...
                                        <div className="mt-1">
                                            <span className="inline-flex bg-blue-50 text-blue-700 border border-blue-200 dark:bg-blue-950 dark:text-blue-300 dark:border-blue-800 text-xs font-medium px-2.5 py-0.5 rounded-full">
