...
export class Client {
    ...
    documentGET(documentKey: string): Promise<FileResponse> {
        ...
        if (documentKey === undefined || documentKey === null)
            throw new globalThis.Error("The parameter 'documentKey' must be defined.");
    ...
    processes2(processId: string): Promise<void> {
        ...
        if (processId === undefined || processId === null)
            throw new globalThis.Error("The parameter 'processId' must be defined.");
    ...
    instancesDELETE(processId: string, processInstanceId: string): Promise<void> {
        ...
        if (processInstanceId === undefined || processInstanceId === null)
            throw new globalThis.Error("The parameter 'processInstanceId' must be defined.");
    ...
    nodeInstancesPOST(nodeInstanceId: string, processId: string, processInstanceId: string): Promise<void> {
        ...
        if (nodeInstanceId === undefined || nodeInstanceId === null)
            throw new globalThis.Error("The parameter 'nodeInstanceId' must be defined.");
...
export class Bommel implements IBommel {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.organization = _data["organization"] ? Organization1.fromJS(_data["organization"]) : undefined as any;
...
export class NewOrganizationModelInput implements INewOrganizationModelInput {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.owner = _data["owner"] ? Member.fromJS(_data["owner"]) : undefined as any;
            this.organization = _data["organization"] ? Organization1.fromJS(_data["organization"]) : undefined as any;
            this.newPassword = _data["newPassword"];
        }
    }
...
export class Organization1 implements IOrganization1 {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.address = _data["address"] ? Organization.fromJS(_data["address"]) : undefined as any;
...
export class TransactionRecord implements ITransactionRecord {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.sender = _data["sender"] ? TradeParty.fromJS(_data["sender"]) : undefined as any;
            this.recipient = _data["recipient"] ? TradeParty.fromJS(_data["recipient"]) : undefined as any;
