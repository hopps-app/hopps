package app.hopps.az.document.ai.service;
...
public interface DocumentTagService
{
	@SystemMessage("""
		...
		you will output tags like "cloud", "servers" and "hosting".

		Do not output meta tags like "invoice", "receipt", "cash",
		"document", "payment", "transaction", "expense", "bill".

		If needed, return an empty list.
		""")
